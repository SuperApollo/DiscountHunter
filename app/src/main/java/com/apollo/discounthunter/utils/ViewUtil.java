...
import com.apollo.discounthunter.widgets.ListViewFooter;
import com.apollo.discounthunter.widgets.ListViewHeader;
...
public class ViewUtil {
     ...
     *
     * @param absListView   the abs list mView
     ...
     * @param lineNumber    每行几个 ListView一行一个item
     * @param verticalSpace the vertical space
     * @return the abs list mView height
     */
