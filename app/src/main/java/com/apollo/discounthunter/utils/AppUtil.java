...
import com.apollo.discounthunter.base.AbProcessInfo;
import com.apollo.discounthunter.base.AbPsRow;
import com.apollo.discounthunter.base.AppCPUInfo;
import com.apollo.discounthunter.base.AppProcessInfo;
...
public class AppUtil {
    ...
    public static AbProcessInfo getMemInfo(String processName) {
        ...
        if (process.memory == 0) {
            LogUtil.d(AppUtil.class, "##" + processName + ",top -n 1未找到");
        }
        return process;
    }
    ...
    public static String getDataPath() {
        ...
        if (isExistSDcard())
            ...
            path = BaseApplication.getBaseApplication().getFilesDir().getPath();
        if (!path.endsWith("/"))
            path = path + "/";
        return path;
    }
