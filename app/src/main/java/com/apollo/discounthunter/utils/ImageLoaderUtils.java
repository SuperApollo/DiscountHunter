...
public class ImageLoaderUtils {
    ...
    private void initConfig() {
        ...
        displayImageOptions = new DisplayImageOptions.Builder()
                .showStubImage(R.mipmap.icon_logo)
                .showImageForEmptyUri(R.mipmap.icon_logo)
                .showImageOnFail(R.mipmap.icon_logo).cacheInMemory()
                .cacheOnDisc().displayer(new SimpleBitmapDisplayer())
                .imageScaleType(ImageScaleType.EXACTLY_STRETCHED).build();

//        displayCircleImageOptions = new DisplayImageOptions.Builder()
//                .showStubImage(R.mipmap.icon_logo)
//                .showImageForEmptyUri(R.mipmap.icon_logo)
//                .showImageOnFail(R.mipmap.icon_logo).cacheInMemory()
//                .cacheOnDisc().displayer(new CircleBitmapDisplayer(100, 100))
//                .imageScaleType(ImageScaleType.EXACTLY_STRETCHED).build();
